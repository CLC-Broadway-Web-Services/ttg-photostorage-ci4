                ...
                <div class="nk-chat-body profile-shown">
                    <div class="nk-chat-head">
                        ...
                        <ul class="nk-chat-head-tools">
                            ...
                            <li class="mr-n1 mr-md-n2"><a href="#" class="btn btn-icon btn-trigger text-primary "><em class="icon ni ni-alert-circle-fill"></em></a></li>
                        </ul>
                        <div class="nk-chat-head-search">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control form-round" id="" placeholder="Search in Conversation">
                                </div>
                            </div>
