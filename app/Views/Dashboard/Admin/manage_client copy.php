            ...
            <div class="modal-body">
                <div class="form-validate is-alter row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select" id="modal_client_crn_status" name="crn_status" onchange="changeClientType(this)" required placeholder="Select Client Status">
...
<script>
    ...
    function changeClientType(event) {
        ...
        if (event.value == 'normal') {
            $('#modal_client_country').val('');
            $('#modal_client_country').removeAttr('required');
        } else {
            $('#modal_client_country').attr('required', 'required');
        }
    }
