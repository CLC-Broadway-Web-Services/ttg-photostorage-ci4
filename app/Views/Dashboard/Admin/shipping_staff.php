                ...
                <div class="form-validate is-alter row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <select name="country" class="country form-control" id="modal_shipping_country" required placeholder="Country">
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#modal_shipping_country').val(response.country).trigger('change');
