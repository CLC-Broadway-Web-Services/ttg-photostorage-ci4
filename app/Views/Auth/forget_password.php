                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="html/index.html" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="/public/images/jsTree/TTG-Photo Storage-Favicon.png" srcset="./images/logo2x.png 2x" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="/public/images/jsTree/TTG-Photo Storage-Favicon.png" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                            </a>
                        </div>
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div class="form-note-s2 text-center pt-4">
                                    <a href="<?= route_to('login') ?>"><strong>Return to login</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
