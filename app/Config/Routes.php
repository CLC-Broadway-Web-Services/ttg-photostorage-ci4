...
$routes->group('/', ['filter' => 'superadminauth'], function ($routes) {
    ...
    $routes->get('/create-user', 'Admin\ManageUsersController::creat_user', ['as' => 'creat_user']);
    // $routes->post('/create-user/create', 'Admin\ManageUsersController::create', ['as' => 'create']);
    $routes->post('/create-user/create', 'Admin\ManageUsersController::edit_manage_user', ['as' => 'create']);
